...
2. If following this lab as part of an IBM instructor led workshop, login into to the terminal server with the credentials provided to you
...
4. Initialize the Helm client
```
   helm init --client-only
```

5. Go to the folder where you cloned the Plants By WebSphere  app in the previous lab
```
...
```
   helm delete --purge pbw-liberty-mariadb-$USER --tls
```
